...
async function exportarTabla(entidad, formato) {
    try {
        const token = localStorage.getItem('token');
        const res = await fetchConAuth(`/api/reportes/exportar/${entidad}/${formato}`);
        if (!res.ok) {
...
async function cargarGraficoVentas() {
    try {
        const token = localStorage.getItem('token');
        const res  = await fetchConAuth('/api/dashboard/ventas-mes');
        const data = await res.json();
...
async function cargarGraficoProductos() {
    try {
        const token = localStorage.getItem('token');
        const res  = await fetchConAuth('/api/dashboard/productos-vendidos');
        const data = await res.json();
...
async function cargarGraficoStock() {
    try {
        const token = localStorage.getItem('token');
        const res  = await fetchConAuth('/api/dashboard/stock');
        const data = await res.json();
...
async function cargarColaboradores() {
    try {
        const token = localStorage.getItem('token');
        const res = await fetchConAuth('/api/colaboradores');
...
async function cargarSelectCargos() {
    const token = localStorage.getItem('token');
    const res  = await fetchConAuth('/api/colaboradores/cargos');
    const data = await res.json();
